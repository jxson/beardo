...
function createTemplateFunction(options) {
...
function Beardo(options) {
  ...
  debug('init with layout %s', beardo.layout)
}
...
Beardo.prototype.render = function(key, context, callback) {
  ...
  context.layout = context.layout || beardo.layout

  // context.layout could be === false
  // if (context.layout === undefined) context.layout = 'default'
  // if (beardo.layout !== undefined) context.layout = beardo.layout
